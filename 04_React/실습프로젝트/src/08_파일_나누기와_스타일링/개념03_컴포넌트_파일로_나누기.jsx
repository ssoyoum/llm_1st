// ============================================================
// 08단원 · 개념 03 — 컴포넌트 파일로 나누기
// ------------------------------------------------------------
// 실행: 실습프로젝트에서 npm run dev → 왼쪽 목록에서 이 예제를 고르세요.
//       F12 → Console 도 함께 보세요.
// ============================================================
//
// 개념02에서 import 와 export 를 배웠습니다.
...
//   JSX 를 쓰는데도 이 파일에 React 라는 이름이 없습니다. 섹션 4에서 이유를 봅니다.
...
//   MenuRow.jsx 를 08_파일_나누기와_스타일링 폴더 바로 아래에 두면
...
function Section4Demo() {
  ...
  //   그래서 이 방식을 쓰면 파일마다 import React from "react"; 가 꼭 있어야 했습니다.
  //   빠뜨리면 "React is not defined" 에러가 났습니다.
  //
...
// ✏️ 직접 해보기 7 — 방금 만든 Footer.jsx 를 _부품 폴더 밖(08_파일_나누기와_스타일링 바로 아래)으로
...
//   MenuRow.jsx 를 _부품 안이 아니라 08_파일_나누기와_스타일링 바로 아래에 두면
...
export default function Concept03SplitFiles() {
  ...
  return (
    <div>
      <h1>개념 03 — 컴포넌트 파일로 나누기</h1>

      <p className="guide">
        이 파일이 쓰는 부품은 <code>src/08_파일_나누기와_스타일링/_부품/</code> 안에 있습니다.
