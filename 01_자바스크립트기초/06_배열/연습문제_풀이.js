...
for (const price of prices15) {
    ...
    console.log(avg=sum/prices15.length);
...
for (let index = 0; index < cart17.length; index++) {
  console.log(`${index + 1}. ${cart17[index]} ${prices17[index]}원`);

  sum += prices17[index];
}

console.log(`합계 ${sum17}원`);
// ───── 문제 18 ───── [도전]
...
console.log(`최고기온 ${temp}도 ${n18+1}번째`);
// ───── 문제 19 ───── (에러 확인 — 맨 마지막)
