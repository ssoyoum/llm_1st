...
// TODO: 여기에 코드를 쓰세요
function order(item,i=1) {
  console.log(`${item} ${i}개`);
}
order("라떼")
order("케이크",3)
// ───── 문제 6 ───── (개념03 return)
...
// TODO: 여기에 코드를 쓰세요
function getTotal(item,count) {
  return item*count
}
console.log(`합계 ${getTotal(4500,4)}원`);
// ───── 문제 8 ───── (개념03 조기 반환)
...
// TODO: 여기에 코드를 쓰세요
const getDiscounted=(price,discount) =>(price*(1-discount))
...
const total = getRawTotal(1200, 5);
const finalPrice = applyDiscount(total, true);

console.log(`합계 ${finalPrice}원`);
