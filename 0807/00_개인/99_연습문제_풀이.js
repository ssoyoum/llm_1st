...
let testResult = wrongCount==0 ? "통과" : "재시험";
let periodName = currentHour>=18 ? "야간 자습" : "정규 수업";
...
// TODO: 여기에 작성
let sum = 0;
for (let index = 0; index < mealCounts.length; index++) {
    let element = mealCounts[index];
    
    sum += element;
}

let avg = sum/mealCounts.length;
