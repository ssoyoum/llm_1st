...
// TODO: 여기에 코드를 쓰세요
subjects4.forEach((n,i) => console.log(`${i+1}. ${n}`));
...
// TODO: 여기에 코드를 쓰세요
menu5.forEach((n) => console.log(`${n.name} ${n.price}원`));
...
// TODO: 여기에 코드를 쓰세요
console.log(
  cart15.reduce((acc, n)=> acc+ n.count * n.price,0)
);
...
console.log(
  products10
    .filter((n)=>n.stock!==0)
    .reduce((acc,n)=>acc + n.price * n.stock,0)
);
